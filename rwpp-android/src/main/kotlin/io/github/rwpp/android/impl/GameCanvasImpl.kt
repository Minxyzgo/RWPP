...
class GameCanvasImpl : GameCanvas {
    override fun drawText(
        ...
        GameEngine.t().bL.a(text, x, y, getPaint(paint))
    }

    override fun drawRect(rect: Rect, paint: GamePaint) {
        GameEngine.t().bL.a(getRect(rect), getPaint(paint))
    }
    ...
    override fun drawCircle(
        ...
        GameEngine.t().bL.a(x, y, radius, getPaint(paint))
    }
    ...
    override fun drawLine(
        ...
        GameEngine.t().bL.a(startX, startY, endX, endY, getPaint(paint))
    }

    override fun scale(scaleX: Float, scaleY: Float) {
        GameEngine.t().bL.a(scaleX, scaleY)
    }
}